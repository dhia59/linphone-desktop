...
#ifndef MVVM_MANAGER_MODEL_H
#define MVVM_MANAGER_MODEL_H
...
class MVVMManager : public QObject {
	Q_OBJECT
public:
	MVVMManager (QObject * parent = nullptr);
	virtual ~MVVMManager();
...
private:
	std::shared_ptr<MVVMModel> mVocalRecorder;
};
#endif
