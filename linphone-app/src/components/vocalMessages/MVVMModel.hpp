...
class MVVMModel : public QObject {
	Q_OBJECT
	
public:
	static std::shared_ptr<MVVMModel> create(QObject * parent = nullptr);// Call it instead constructor
	MVVMModel (QObject * parent = nullptr);
	virtual ~MVVMModel();
...
Q_DECLARE_METATYPE(std::shared_ptr<MVVMModel>)
Q_DECLARE_METATYPE(MVVMModel*)
#endif // MVVM_MODEL_H
