...
Item {
	...
	Item{
		...
		Text {
            ...
            text: "Aucun message vocal disponible"//qsTr('titleNoRecordings')
            visible :! mvvmProxyModel.isLoading && mvvmProxyModel.count === 0
        ...
        Loader{
               ...
               visible: mvvmProxyModel.isLoading
               anchors.fill: parent
               onVisibleChanged: {
                   console.log("visibleeee ", mvvmProxyModel.isLoading)
               }
         }
		Component {
			id: sectionHeading
		...
		ScrollableListView {
			...
			id: recordingsList
			spacing: 0
            model: MVVMProxyModel {
                id: mvvmProxyModel
                onIsLoadingChanged:{console.log("okkkkkkkkkkkkkk ", mvvmProxyModel.isLoading)}
			}
								...
								window.attachVirtualWindow(Utils.buildCommonDialogUri('ConfirmDialog'), {
															//: 'Are you sure you want to delete this item?' : Confirmation message for removing a record.
															   ...
															   if (status) {
                                                                    ...
                                                                    mvvmProxyModel.remove($modelData)
															   }
														   })
