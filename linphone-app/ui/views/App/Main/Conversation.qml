                    ...
                    Icon{
                        ...
                        MouseArea{
                            ...
                            function showParticipantsDevice(){
                                ...
                                mainwindow.attachVirtualWindow(Qt.resolvedUrl('Dialogs/ParticipantsDevices.qml')
                            ...
                            onClicked : {
                                if(!SettingsModel.dontAskAgainInfoEncryption){
                                    window.detachVirtualWindow()
                                    mainwindow.attachVirtualWindow(Qt.resolvedUrl('Dialogs/InfoEncryption.qml')
            ...
            Row {
                ...
                Menu{
                   ...
                   /* MenuItem{
                        ...
                        onTriggered: {
                            console.log("xxxxxxxxxxxxxxxxgetFullPeerAddress : "+conversation.getFullPeerAddress())
                    ...
                    MenuItem{
                        ...
                        onTriggered: {
                            window.detachVirtualWindow()
                            mainwindow.attachVirtualWindow(Qt.resolvedUrl('Dialogs/InfoChatRoom.qml')
                                                       ,{chatRoomModel:chatRoomModel})
                        }
                    }
                    Rectangle{
                    ...
                    MenuItem{
                        ...
                        onTriggered: {
                            window.detachVirtualWindow()
                            mainwindow.attachVirtualWindow(Qt.resolvedUrl('Dialogs/EphemeralChatRoom.qml')
                                                       ,{chatRoomModel:chatRoomModel})
                        }
                    }
                    Rectangle{
