...
QtObject {
    ...
    property var buzyColor: ColorsList.add(sectionName+'_indicator', 'n')
	...
	property QtObject recordWarning: QtObject{
        ...
        property var colorModel: ColorsList.add(sectionName+'_warning_fg', 'n')
	...
	property QtObject grid: QtObject {
		...
		property QtObject cell: QtObject {
			...
			property QtObject contactDescription: QtObject {
                property var colorModel: ColorsList.add(sectionName+'_username', 'n')
				property int pointSize: Units.dp * 12
	...
	property QtObject pauseArea: QtObject {
		...
		property QtObject title: QtObject{
            property var colorModel: ColorsList.add(sectionName+'_paused_title', 'n')
			property int pointSize: Units.dp * 12
			property int weight: Font.Bold
		}
		property QtObject description: QtObject{
            property var colorModel: ColorsList.add(sectionName+'_paused_description', 'n')
			property int pointSize: Units.dp * 9
...
//------------------------------------------------------------------------------
		property QtObject chat: QtObject {
			property int iconSize: 40
            property string icon :'chat_square'
            property string name : 'chat'
            property var backgroundNormalColor : ColorsList.addImageColor(sectionName+'_'+name+'_bg_n', icon, 'c_n_b_bg')
            property var backgroundHoveredColor : ColorsList.addImageColor(sectionName+'_'+name+'_bg_h', icon, 'c_h_b_bg')
            property var backgroundPressedColor : ColorsList.addImageColor(sectionName+'_'+name+'_bg_p', icon, 'c_p_b_bg')
            property var backgroundUpdatingColor : ColorsList.addImageColor(sectionName+'_'+name+'_bg_c', icon, 'c_p_b_bg')
            property var foregroundNormalColor : ColorsList.addImageColor(sectionName+'_'+name+'_fg_n', icon, 'c_n_b_fg')
            property var foregroundHoveredColor : ColorsList.addImageColor(sectionName+'_'+name+'_fg_h', icon, 'c_h_b_fg')
            property var foregroundPressedColor : ColorsList.addImageColor(sectionName+'_'+name+'_fg_p', icon, 'c_p_b_fg')
            property var foregroundUpdatingColor : ColorsList.addImageColor(sectionName+'_'+name+'_fg_c', icon, 'c_p_b_fg')
		}
		...
		property QtObject options: QtObject {
            property int iconSize: 40
            property string icon : 'menu_vdots_custom_incall'
