...
ApplicationWindow {
                    ...
                    Rectangle{
                            ...
                            onEntrySelected:{
                                if( entry ) {
                                    if( entry.selected){
                                        ...
                                        console.log("timelinesetitem0: "+entry.chatRoomModel.subject )
                                        console.log("timelinesetitem: "+firstItem.subject )
                                    }
                                }else{
                        ...
                        ApplicationMenu {
                            ...
                            ApplicationMenuEntry {
                                ...
                                iconSize: MainWindowStyle.menu.conferences.iconSize
                                overwriteColor: isSelected ? MainWindowStyle.menu.conferences.selectedColor.color : MainWindowStyle.menu.conferences.colorModel.color
                                name: qsTr('Parametres').toUpperCase()
                                visible: true
    ...
    Component.onCompleted:{ if(Qt.platform.os === 'osx') menuBar = customMenuBar;
        window.setView('Conversation', {
                           chatRoomModel:timeline.firstItem.chatRoomModel
                       })
