...
set_target_properties(bellesip PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "bctoolbox;belr"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/bellesip.dll"
  )

list(APPEND _cmake_import_check_targets bellesip )
list(APPEND _cmake_import_check_files_for_bellesip "${_IMPORT_PREFIX}/lib/bellesip.lib" "${_IMPORT_PREFIX}/bin/bellesip.dll" )
