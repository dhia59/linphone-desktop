...
set_target_properties(ldap PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/ldap.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "mbedtls;mbedx509;mbedcrypto"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/ldap.dll"
  )
...
set_target_properties(lber PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/lber.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/lber.dll"
  )
