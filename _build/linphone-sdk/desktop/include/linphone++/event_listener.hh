...
namespace linphone {
	...
	class EventListener: public Listener {
		...
		public:
			 ...
			 *
			 * @param linphoneEvent The LinphoneEvent object that has sent the NOTIFY and for
			 * which we received a response   
			 */
			LINPHONECXX_PUBLIC virtual void onNotifyResponse(const std::shared_ptr<const linphone::Event> & linphoneEvent) {};
