...
namespace linphone {
	 ...
	 * 
	 */
	enum class ConferenceJoiningMode {
		/**
	...
	/**
	 * @ref ConferenceLayout is used to indicate the layout used by the conference. 
	 * 
	 */
	 ...
	 * 
	 */
	enum class ConferenceParticipantListType {
		/**
	...
	/**
	 * @ref ParticipantDeviceDisconnectionMethod is used to indicate how a participant
	 * left a conference. 
	 * 
	 */
	enum class ParticipantDeviceDisconnectionMethod {
		/**
	...
	/**
	 * @ref ParticipantDeviceJoiningMethod is used to indicate how a participant
	 * joined a conference or if it is the focus. 
	 * 
	 */
	enum class ParticipantDeviceJoiningMethod {
		/**
	...
	/**
	 * @ref ParticipantDeviceState is used to list all states a participant device can
	 * be in 
	 * 
	 */
