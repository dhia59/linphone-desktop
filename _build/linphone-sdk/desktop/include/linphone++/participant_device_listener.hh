...
#ifndef _LINPHONE_PARTICIPANT_DEVICE_LISTENER_HH
#define _LINPHONE_PARTICIPANT_DEVICE_LISTENER_HH
...
namespace linphone {
	...
	class ParticipantDeviceListener: public Listener {
		...
		public:
			 ...
			 */
			LINPHONECXX_PUBLIC virtual void onStateChanged(const std::shared_ptr<linphone::ParticipantDevice> & participantDevice, linphone::ParticipantDeviceState state) {};
...
#endif // _LINPHONE_PARTICIPANT_DEVICE_LISTENER_HH
