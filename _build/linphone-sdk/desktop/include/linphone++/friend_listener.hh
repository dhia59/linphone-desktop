...
#ifndef _LINPHONE_FRIEND_LISTENER_HH
#define _LINPHONE_FRIEND_LISTENER_HH
...
namespace linphone {
	...
	class FriendListener: public Listener {
		...
		public:
			 ...
			 * information. 
			 *
			 * @param linphoneFriend The LinphoneFriend object for which the status has
			 * changed   
			 */
...
#endif // _LINPHONE_FRIEND_LISTENER_HH
