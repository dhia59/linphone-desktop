...
namespace linphone {
	...
	class ChatRoomParams: public Object {
		...
		public:
			 ...
			 * given parameters. 
			 *
			 * @return the ephemeral message mode @ref ChatRoomEphemeralMode 
			 */
			LINPHONECXX_PUBLIC linphone::ChatRoomEphemeralMode getEphemeralMode() const;
			
			/**
			 * @brief Enables or disables forcing of ephemeral messages for the chat room
			 * associated with the given parameters. 
			 *
			 * @param mode Ephemeral message mode @ref ChatRoomEphemeralMode. 
			 */
			LINPHONECXX_PUBLIC void setEphemeralMode(linphone::ChatRoomEphemeralMode mode);
