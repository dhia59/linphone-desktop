...
#include <memory>
#include "../../../../../linphone-app/src/components/contacts/ContactsListProxyModel.hpp"
...
void ContactsListProxyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ContactsListProxyModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ContactsListProxyModel::staticMetaObject = { {
    &QSortFilterProxyModel::staticMetaObject,
    qt_meta_stringdata_ContactsListProxyModel.data,
    qt_meta_data_ContactsListProxyModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
