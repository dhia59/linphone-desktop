/****************************************************************************
** Meta object code from reading C++ file 'Units.hpp'
**
...
#include <memory>
#include "../../../../../linphone-app/src/components/other/units/Units.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Units.hpp' doesn't include <QObject>."
...
void Units::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< float*>(_v) = _t->getDp(); break;
        default: break;
        }
