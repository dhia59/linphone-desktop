...
#include <memory>
#include "../../../../../linphone-app/src/components/presence/OwnPresenceModel.hpp"
...
void OwnPresenceModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OwnPresenceModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OwnPresenceModel::*)(Presence::PresenceLevel );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OwnPresenceModel::presenceLevelChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OwnPresenceModel::*)(Presence::PresenceStatus );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OwnPresenceModel::presenceStatusChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OwnPresenceModel::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_OwnPresenceModel.data,
    qt_meta_data_OwnPresenceModel,
    qt_static_metacall,
    qt_meta_extradata_OwnPresenceModel,
    nullptr
} };
