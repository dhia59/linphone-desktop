...
#include <memory>
#include "../../../../../linphone-app/src/components/telephone-numbers/TelephoneNumbersModel.hpp"
...
QT_MOC_LITERAL(1, 22, 5), // "getAt"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 12) // "defaultIndex"

    },
    "TelephoneNumbersModel\0getAt\0\0defaultIndex"
};
...
static const uint qt_meta_data_TelephoneNumbersModel[] = {
 ...
 // methods: parameters
    QMetaType::QVariant, QMetaType::Int,    2,
...
void TelephoneNumbersModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TelephoneNumbersModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QVariant _r = _t->getAt((*reinterpret_cast< int(*)>(_a[1])));
...
QT_INIT_METAOBJECT const QMetaObject TelephoneNumbersModel::staticMetaObject = { {
    &ProxyAbstractObject::staticMetaObject,
    qt_meta_stringdata_TelephoneNumbersModel.data,
    qt_meta_data_TelephoneNumbersModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TelephoneNumbersModel::qt_metacast(const char *_clname)
{
    ...
    return ProxyAbstractObject::qt_metacast(_clname);
}

int TelephoneNumbersModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ProxyAbstractObject::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
