...
#include <memory>
#include "../../../../../linphone-app/src/components/sip-addresses/SipAddressesProxyModel.hpp"
...
void SipAddressesProxyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SipAddressesProxyModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SipAddressesProxyModel::staticMetaObject = { {
    &QSortFilterProxyModel::staticMetaObject,
    qt_meta_stringdata_SipAddressesProxyModel.data,
    qt_meta_data_SipAddressesProxyModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
