...
#include <memory>
#include "../../../../../linphone-app/src/components/conference/ConferenceHelperModel.hpp"
...
void ConferenceHelperModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ConferenceHelperModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ConferenceHelperModel::staticMetaObject = { {
    &QSortFilterProxyModel::staticMetaObject,
    qt_meta_stringdata_ConferenceHelperModel.data,
    qt_meta_data_ConferenceHelperModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
