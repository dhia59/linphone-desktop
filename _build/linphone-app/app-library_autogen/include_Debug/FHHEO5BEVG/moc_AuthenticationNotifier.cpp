...
#include <memory>
#include "../../../../../linphone-app/src/components/authentication/AuthenticationNotifier.hpp"
...
void AuthenticationNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AuthenticationNotifier *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AuthenticationNotifier::*)(const QVariant & , const QString & , const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AuthenticationNotifier::authenticationRequested)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AuthenticationNotifier::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_AuthenticationNotifier.data,
    qt_meta_data_AuthenticationNotifier,
    qt_static_metacall,
    nullptr,
    nullptr
} };
