...
#include <memory>
#include "../../../../../linphone-app/src/components/url-handlers/UrlHandlers.hpp"
...
void UrlHandlers::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UrlHandlers::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UrlHandlers::sip)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UrlHandlers::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_UrlHandlers.data,
